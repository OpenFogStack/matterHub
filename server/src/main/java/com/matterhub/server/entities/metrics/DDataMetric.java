...
public record DDataMetric(short endpointId, int clusterId, int attributeId, long timestamp, DataType dataType,
                          JsonNode value)
        implements Metric {
    ...
    public Endpoint toEndpoint() {
        ...
        cl.Attributes()
          .stream()
          .filter(attr -> attr.Id() == this.attributeId)
          .findFirst()
          .orElseThrow()
          .fromMatterValue(this.value);
